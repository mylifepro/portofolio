...
const aboutSkills = [
...

  {
    ...
    description: "Modélisation et gestion des données avec PostgreSQL.",
...

  {
    ...
    description: "Automatisation et intégration de solutions basées sur l'IA.",
...
export default function About() {
  return (
    <section
      id="about"
      className=" relative overflow-hidden py-24 bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-white "
    >
      {/* Background */}
      ...
      <div className=" relative max-w-7xl mx-auto px-6 ">
        ...
        >
          ...
          <p className=" mt-6 max-w-3xl mx-auto text-lg text-zinc-600 dark:text-zinc-400 leading-relaxed ">
            Je conçois des applications web modernes, performantes et évolutives
            en combinant développement frontend, backend, bases de données et
        ...
        <div className=" grid lg:grid-cols-2 gap-12 items-start ">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className=" rounded-3xl p-8 bg-white/70 dark:bg-zinc-900/60 backdrop-blur-xl border border-zinc-200 dark:border-zinc-800 shadow-xl "
          >
            <h3 className=" text-3xl font-bold mb-4 ">{profile.title}</h3>
...
"
                  >
                    <Icon size={30} className="text-emerald-400" />
                  </div>
